                ...
                <div className="mt-4 flex items-start">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-xs text-gray-500">
                      문의 처리를 위해 수집된 개인정보는 개인정보처리방침에 따라
                      3년 후 파기됩니다.
                    </p>
                  </div>
                </div>
