...
const MessageItem = ({
  ...
  useEffect(() => {
    if (messages && chatMemoList) {
      const memoedIds = messages.content
        .filter((msg) =>
  ...
  return (
    <div className="relative mb-4">
      <motion.div
        className="relative z-10 min-h-[47px] max-w-[600px] cursor-pointer rounded-[21px] border border-[#363D55] py-[10px] pl-[18px] pr-[33px]"
